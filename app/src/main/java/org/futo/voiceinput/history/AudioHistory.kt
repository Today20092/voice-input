...
suspend fun Context.retranscribeAudio(id: String, scope: LifecycleCoroutineScope): String =
    withContext(Dispatchers.IO) {
        ...
        store.retranscribe(id) { samples ->
            ...
            check(lifecycle.readiness(selection)?.isReady != false) {
            ...
            val backend = lifecycle.load(this@retranscribeAudio, selection,
                RecognitionRuntimeCallbacks({}, {}, { null }))
            try {
